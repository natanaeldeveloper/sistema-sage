...
public class Janela_login_supervisor extends JFrame {
	/**
	 * 
	 */
	 ...
	 * Create the frame.
	 */
	public Janela_login_supervisor() {
		...
		JLabel lblGerente = new JLabel("Logar Supervisor");
		...
		b_entrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ControllerSupervisor controller = new ControllerSupervisor();
				String cpf = c_user.getText();
