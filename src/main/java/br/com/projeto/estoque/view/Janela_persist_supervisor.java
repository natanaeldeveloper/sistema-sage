...
public class Janela_persist_supervisor extends JInternalFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	JFormattedTextField c_cpf;
	ControllerSupervisor ctrls = new ControllerSupervisor();
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Janela_persist_supervisor frame = new Janela_persist_supervisor();
	...
	public Janela_persist_supervisor() {
		...
		lblNewLabel_3.setBounds(119, 249, 253, 27);
		...
		lblNewLabel_5.setBounds(405, 176, 253, 27);
		...
		c_cpf.setBounds(405, 200, 253, 25);
		...
		final JPasswordField c_confSenha = new JPasswordField();
		c_confSenha.setBounds(119, 274, 253, 25);
		c_confSenha.setBackground(SystemColor.controlHighlight);
		getContentPane().add(c_confSenha);
		c_confSenha.setColumns(10);
