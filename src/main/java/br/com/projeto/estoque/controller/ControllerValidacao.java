...
public class ControllerValidacao {
	...
	public boolean testarCamposCadastroSupervisor(String cpf_supervisor, String senha_supervisor, String login_supervisor, String confSenha_supervisor) {
		if (cpf_supervisor.equals("") || senha_supervisor.equals("") || login_supervisor.equals("") || confSenha_supervisor.equals("")) {
			return false;
		} else {
			return true;
		}
	...
	public static boolean testarCampos(String novo_cpf_supervisor, String nova_senha_supervisor, String novo_login_supervisor) {
		if (novo_cpf_supervisor.equals("   .   .   -  ") || nova_senha_supervisor.equals("") || novo_login_supervisor.equals("")) {
			return false;
		} else {
			return true;
		}
